...
export const PHOTOS = {
  ...
  ryu_fw: {
    ...
    exif: { fecha: '12/07 · 22:41', lugar: 'Puente Kanade', disp: 'ASSIST Cam', tam: '2.1 MB' },
    anomaly: 'reflection',
  ...
  kenta_room: {
    ...
    exif: { fecha: '26/07 · 19:44', lugar: 'Apartamento 4B', disp: 'ASSIST Cam', tam: '1.2 MB' },
    anomaly: 'door',
    corruptExif: { fecha: '26/07 · 19:44', lugar: 'APT-4B (plantilla)', disp: 'ASSIST Cam', tam: '1.2 MB', extra: 'GEOMETRÍA: SECTOR C / CELDA 02' },
  ...
  lara_momo2: {
    of: 'lara', scene: 'dog',
    // Cuando lara_momo tenga arte, ESTA apunta al MISMO fichero, a
    // propósito: su anomalía es que es la misma foto, no una parecida.
    // Cambia el pie, no la imagen. Nunca se pinta una segunda.
    ...
    anomaly: 'dup',
    corruptExif: { fecha: '16/07 · 18:02', lugar: 'Parque Higashi', disp: 'ASSIST Cam', tam: '2.0 MB', extra: 'HASH IDÉNTICO A lara_momo' },
  ...
  lara_fest: {
    ...
    exif: { fecha: '29/07 · 21:15', lugar: 'Festival de verano', disp: 'ASSIST Cam', tam: '3.1 MB' }
  },
  lara_empty: {
    of: 'lara', scene: 'empty',
    title: '(sin título)',
  ...
  group_fest: {
    ...
    exif: { fecha: '29/07 · 21:20', lugar: 'Festival de verano', disp: 'ASSIST Cam', tam: '3.4 MB' }
  },
  sys_chairs: {
    of: null, scene: 'lab',
